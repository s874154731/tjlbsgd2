...
import com.sgd.tjlb.zhxf.aop.Permissions;
 ...
 *    desc   : 消息 Fragment
 */
public final class Func3Fragment extends TitleBarFragment<HomeActivity> {

    private ImageView mImageView;

    public static Func3Fragment newInstance() {
        return new Func3Fragment();
    }

    @Override
    protected int getLayoutId() {
        return R.layout.func3_fragment;
    }
    ...
    public void onClick(View view) {
        ...
        if (viewId == R.id.btn_message_image1) {
            ...
            HomeActivity.start(getActivity(), FuncFragment.class);
        }
    }
