...
import com.sgd.tjlb.zhxf.ui.adapter.TabAdapter;
 ...
 */
public final class MyAddressDialog {
    ...
    public static final class Builder
        ...
        private List<CityInfo> mCustomAreas = new ArrayList<>();
...
//            mAdapter.addItem(mCustomAreas);
         ...
         * 设置自定义数据源
         */
        public void setCustomCityDatas(List<CityInfo> areaDatas){
            mCustomAreas.clear();
            mCustomAreas.addAll(areaDatas);
        }
