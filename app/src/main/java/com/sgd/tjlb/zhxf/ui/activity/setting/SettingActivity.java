package com.sgd.tjlb.zhxf.ui.activity.setting;
...
import com.sgd.tjlb.zhxf.http.api.LogoutApi;
import com.sgd.tjlb.zhxf.http.glide.GlideApp;
import com.sgd.tjlb.zhxf.http.model.HttpData;
import com.sgd.tjlb.zhxf.manager.ActivityManager;
import com.sgd.tjlb.zhxf.manager.CacheDataManager;
import com.sgd.tjlb.zhxf.manager.ThreadPoolManager;
...
import com.sgd.tjlb.zhxf.ui.dialog.SafeDialog;
...
public final class SettingActivity extends AppActivity
    ...
    public void onClick(View view) {
        ...
        if (viewId == R.id.sb_setting_language) {
            ...
            new SafeDialog.Builder(this)
                    .setListener((dialog, phone, code) -> PasswordForgetAfterActivity.start(getActivity(), phone, code))
                    .show();
