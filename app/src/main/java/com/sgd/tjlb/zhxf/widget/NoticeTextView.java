...
public class NoticeTextView extends TextSwitcher implements ViewSwitcher.ViewFactory {
    ...
    private int maxLength = 2000;//最大显示数量
    ...
    public void setText(float textSize, int padding, int textColor) {
        setText(textSize, padding, textColor, 100);
    }
     ...
     */
    public void setText(float textSize, int padding, int textColor, int maxLength) {
        mTextSize = textSize;
        mPadding = padding;
