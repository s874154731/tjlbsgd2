...
import com.sgd.tjlb.zhxf.http.api.RegisterApi;
...
public final class RegisterActivity extends AppActivity
    ...
    private AppCompatImageView mIvBtnClose;
    ...
    protected void initView() {
        ...
        mIvBtnClose = findViewById(R.id.iv_btn_close);

        setOnClickListener(mCountdownView, mCommitView, mIvBtnClose);
        ...
        if (view == mCountdownView) {
            ...
            EasyHttp.post(this)
                    .api(new SendCodeApi()
                            ...
                            .setType(SendCodeApi.TYPE_REGISTER))
            ...
            EasyHttp.post(this)
                    .api(new RegisterApi()
                            .setPhone(mPhoneView.getText().toString())
                            .setNewPwd(mFirstPassword.getText().toString())
                            .setRepPwd(mSecondPassword.getText().toString())
