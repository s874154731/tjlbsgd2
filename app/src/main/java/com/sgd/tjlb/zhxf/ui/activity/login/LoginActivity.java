...
public final class LoginActivity extends AppActivity
    ...
    private AppCompatTextView mForgetView;
                        ...
                        public void onSucceed(HttpData<UserInfo> data) {
                            ...
                            postDelayed(() -> {
                                ...
                                postDelayed(() -> {
                                    ...
                                    userInfo.setTel(mPhoneView.getText().toString());
