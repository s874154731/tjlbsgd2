...
import com.sgd.tjlb.zhxf.ui.activity.BrowserActivity;
import com.sgd.tjlb.zhxf.ui.activity.DialogActivity;
import com.sgd.tjlb.zhxf.ui.activity.init.GuideActivity;
...
import com.sgd.tjlb.zhxf.ui.activity.login.PasswordForgetActivity;
import com.sgd.tjlb.zhxf.ui.activity.login.PasswordForgetAfterActivity;
import com.sgd.tjlb.zhxf.ui.activity.user.PersonalDataActivity;
import com.sgd.tjlb.zhxf.ui.activity.user.PhoneResetActivity;
import com.sgd.tjlb.zhxf.ui.activity.login.RegisterActivity;
import com.sgd.tjlb.zhxf.ui.activity.setting.SettingActivity;
import com.sgd.tjlb.zhxf.ui.activity.StatusActivity;
import com.sgd.tjlb.zhxf.ui.activity.VideoPlayActivity;
import com.sgd.tjlb.zhxf.ui.activity.VideoSelectActivity;
import com.sgd.tjlb.zhxf.ui.dialog.InputDialog;
 ...
 *    desc   : 我的 Fragment
 */
public final class Func4Fragment extends TitleBarFragment<HomeActivity> {

    public static Func4Fragment newInstance() {
        return new Func4Fragment();
    }

    @Override
    protected int getLayoutId() {
        return R.layout.func4_fragment;
    }
    ...
    public void onClick(View view) {
        ...
        if (viewId == R.id.btn_mine_dialog) {
            ...
            startActivity(PasswordForgetAfterActivity.class);
