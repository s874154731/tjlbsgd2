 ...
 * @ProjectName: tjlb
 * @Package: com.sgd.tjlb.zhxf.widget
 * @ClassName: WeiXinMainPullViewGroup
 * @Description: java类作用描述
 * @CreateDate: 2023/3/10/010 14:21
 * @UpdateUser: shi
 * @UpdateDate: 2023/3/10/010 14:21
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 */
class WeiXinMainPullViewGroup @JvmOverloads constructor(
    ...
    init {
        ...
        paint.alpha = 255;
        paint.color = ContextCompat.getColor(context!!, R.color.blue_main)
